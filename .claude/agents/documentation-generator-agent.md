...
description: "Use this agent to generate and maintain Laravel project documentation including READMEs, ADRs (Architecture Decision Records), changelogs, and code documentation (PHPDoc)."
model: haiku
...
## Role
Generate and maintain Laravel project documentation: READMEs, ADRs, changelogs, and PHPDoc.
